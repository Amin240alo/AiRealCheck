...
def test_image_providers_missing_keys_not_available(monkeypatch, tmp_path):
    ...
    assert hive_res.get("status") == "not_available"
    ...
    assert se_res.get("status") == "not_available"
    ...
    assert rd_res.get("status") == "not_available"
    ...
    assert sensity_res.get("status") == "not_available"
